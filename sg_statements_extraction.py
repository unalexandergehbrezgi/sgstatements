...
base_url = 'https://www.un.org/sg/en/latest/sg/statement'
...
path_to_save = r'C:/Users/alexa/OneDrive/Dokumente/Arbeit/Arbeitgeber/United Nations/Work/sg_statement_files'
...
for page_number in range(total_page_number):
    ...
    for url in page_urls:
        ...
        # sourcefile
        filename = f'{formatted_date}_SG_Statement_{place}'
